...
- `header`: the finding ID, up to 12 chars (e.g. `S-C1`, `S-I3`)
...
If the user explicitly says "skip risk prompts" or runs with
`--no-prompts` (informal — not a supported flag), do not call
