...
//
// Cross-OS. Never reads the NOTION_TOKEN value — only checks existence.
//
// Run with:
//   deno run --allow-env=NOTION_TOKEN --allow-read --allow-run=mise,deno <this>
...
checks.push([
  "NOTION_TOKEN",
  tokenSet,
  tokenSet ? "set" : "missing — see references/auth-setup.md",
]);
